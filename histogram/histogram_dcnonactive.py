...
def generation():
    ...
    for i in range(FRAGMENTS):
        ...
        # Because it is not critical path, I am going to leave this here
        # (it is "active", but it's not relevant for timing measurements on histogram)
...
def histogram(experiment):
    ...
    for frag in experiment:
        # This is triggering a copy of the numpy array
        values, _ = np.histogram(frag.values, bins)
        partial_results.append(values)
